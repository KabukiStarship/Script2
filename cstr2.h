...
SDK const CH2* TStringDecimalEnd(const CH2* begin);
...
SDK const CH2* TStringSkipChar(const CH2* text, CH2 skip_char);

/* Skips all the spaces at the begin of the CH2. */
SDK const CH2* StringSkipSpaces(const CH2* text);

/* Compares the source and query CH2 as nil-terminated strings. */
SDK const CH2* StringEquals(const CH2* text_a, const CH2* text_b);
...
SDK const CH2* StringFind(const CH2* begin, const CH2* query);
...
SDK CH2* Print(CH2* start, CH2* stop, const CH2* string_);
...
SDK CH2* Print(CH2* start, CH2* stop, UI4 value);
...
@param stop The stop address of the socket.
@param value The value to utf. */
SDK CH2* Print(CH2* start, CH2* stop, SI4 value);
...
@param stop The stop address of the socket.
@param value The value to utf. */
SDK CH2* Print(CH2* start, CH2* stop, UI8 value);
...
@param stop The stop address of the socket.
@param value The value to utf. */
SDK CH2* Print(CH2* start, CH2* stop, SI8 value);
...
@param stop The stop address of the socket.
@param value The value to utf. */
SDK CH2* Print(CH2* start, CH2* stop, FLT value);
...
@param stop The stop address of the socket.
@param value The value to utf. */
SDK CH2* Print(CH2* start, CH2* stop, DBL value);
#endif
...
@param stop    The stop address of the socket.
@param string_ The potentially unsafe string_ to write. */
SDK CH2* PrintCenter(CH2* start, CH2* stop, const CH2* string_,
                     SI4 column_count);
...
SDK CH2* PrintCenter(CH2* start, CH2* stop, CH2 character, SI4 column_count);
...
@param stop The stop address of the socket.
@param value The value to utf. */
SDK CH2* PrintCenter(CH2* start, CH2* stop, UI4 valu, SI4 column_count);
...
@param stop The stop address of the socket.
@param value The value to utf. */
SDK CH2* PrintCenter(CH2* start, CH2* stop, SI4 value, SI4 column_count);
...
@param stop The stop address of the socket.
@param value The value to utf. */
SDK CH2* PrintCenter(CH2* start, CH2* stop, UI8 value, SI4 column_count);
...
@param stop The stop address of the socket.
@param value The value to utf. */
SDK CH2* PrintCenter(CH2* start, CH2* stop, SI8 value, SI4 column_count);
...
@param stop The stop address of the socket.
@param value The value to utf. */
SDK CH2* PrintCenter(CH2* start, CH2* stop, FLT value, SI4 column_count);
...
@param stop The stop address of the socket.
@param value The value to utf. */
SDK CH2* PrintCenter(CH2* start, CH2* stop, DBL value, SI4 column_count);
#endif
...
@param stop    The stop address of the socket.
@param string_ The potentially unsafe string_ to write. */
SDK CH2* PrintRight(CH2* start, CH2* stop, const CH2* string_,
                    SI4 column_count);
...
@param stop       The stop address of the socket.
@param character The value to write. */
SDK CH2* PrintRight(CH2* start, CH2* stop, CH2 character, SI4 column_count);
...
@param stop The stop address of the socket.
@param value The value to utf. */
SDK CH2* PrintRight(CH2* start, CH2* stop, UI4 value, SI4 column_count);
...
@param stop The stop address of the socket.
@param value The value to utf. */
SDK CH2* PrintRight(CH2* start, CH2* stop, SI4 value, SI4 column_count);
...
@param stop The stop address of the socket.
@param value The value to utf. */
SDK CH2* PrintRight(CH2* start, CH2* stop, UI8 value, SI4 column_count);
...
@param stop The stop address of the socket.
@param value The value to utf. */
SDK CH2* PrintRight(CH2* start, CH2* stop, SI8 value, SI4 column_count);
...
@param stop The stop address of the socket.
@param value The value to utf. */
SDK CH2* PrintRight(CH2* start, CH2* stop, FLT value, SI4 column_count);
...
@param stop The stop address of the socket.
@param value The value to utf. */
SDK CH2* PrintRight(CH2* start, CH2* stop, DBL value, SI4 column_count);
#endif
...
@param stop The stop address of the socket.
@param value The value to utf. */
SDK CH2* PrintHex(CH2* start, CH2* stop, UI1 value);
...
@param stop The stop address of the socket.
@param value The value to utf. */
SDK CH2* PrintHex(CH2* start, CH2* stop, SI1 value);
...
@param stop The stop address of the socket.
@param value The value to utf. */
SDK CH2* PrintHex(CH2* start, CH2* stop, UI2 value);
...
@param stop The stop address of the socket.
@param value The value to utf. */
SDK CH2* PrintHex(CH2* start, CH2* stop, SI2 value);
...
@param stop The stop address of the socket.
@param value The value to utf. */
SDK CH2* PrintHex(CH2* start, CH2* stop, UI4 value);
...
@param stop The stop address of the socket.
@param value The value to utf. */
SDK CH2* PrintHex(CH2* start, CH2* stop, SI4 value);
...
@param stop The stop address of the socket.
@param value The value to utf. */
SDK CH2* PrintHex(CH2* start, CH2* stop, UI8 value);
...
@param stop The stop address of the socket.
@param value The value to utf. */
SDK CH2* PrintHex(CH2* start, CH2* stop, SI8 value);
...
@param stop The stop address of the socket.
@param value The value to utf. */
SDK CH2* PrintHex(CH2* start, CH2* stop, FLT value);
...
@param stop The stop address of the socket.
@param value The value to utf. */
SDK CH2* PrintHex(CH2* start, CH2* stop, DBL value);
#endif
...
SDK CH2* TPrintBinary(CH2* start, CH2* stop, const void* pointer);
...
@param stop The stop address of the socket.
@param value The value to utf. */
SDK CH2* TPrintBinary(CH2* start, CH2* stop, UI1 value);
...
@param stop The stop address of the socket.
@param value The value to utf. */
SDK CH2* TPrintBinary(CH2* start, CH2* stop, SI1 value);
...
@param stop The stop address of the socket.
@param value The value to utf. */
SDK CH2* TPrintBinary(CH2* start, CH2* stop, UI2 value);
...
@param stop The stop address of the socket.
@param value The value to utf. */
SDK CH2* TPrintBinary(CH2* start, CH2* stop, SI2 value);
...
@param stop The stop address of the socket.
@param value The value to utf. */
SDK CH2* TPrintBinary(CH2* start, CH2* stop, UI4 value);
...
@param stop The stop address of the socket.
@param value The value to utf. */
SDK CH2* TPrintBinary(CH2* start, CH2* stop, SI4 value);
...
@param stop The stop address of the socket.
@param value The value to utf. */
SDK CH2* TPrintBinary(CH2* start, CH2* stop, UI8 value);
...
@param stop The stop address of the socket.
@param value The value to utf. */
SDK CH2* TPrintBinary(CH2* start, CH2* stop, SI8 value);
...
@param stop The stop address of the socket.
@param value The value to utf. */
SDK CH2* TPrintBinary(CH2* start, CH2* stop, FLT value);
...
@param stop The stop address of the socket.
@param value The value to utf. */
SDK CH2* TPrintBinary(CH2* start, CH2* stop, DBL value);
#endif
...
SDK CH2* PrintSocket(CH2* start, CH2* stop, const void* begin, const void* end);
...
SDK CH2* PrintSocket(CH2* start, CH2* stop, const void* begin, size_t size);
...
SDK CH2* PrintLine(CH2* cursor, CH2* stop, CH2 token, SI4 column_count);
...
SDK CH2* TPrintLineString(CH2* cursor, CH2* stop, const CH2* string_,
                          SI4 column_count);
...
SDK const CH2* Scan(const CH2* begin, SI1& result);
...
@param  value   The value to utf.
@return The printer. */
SDK ::_::UTF2& operator<<(::_::UTF2& printer, const CH2* string_);

/* Writes the given value to the utf.
@param  printer The printer.
@param  value   The value to utf.
@return The printer. */
SDK ::_::UTF2& operator<<(::_::UTF2& printer, CH2 value);

/* Writes the given value to the utf.
@param  printer The printer.
@param  value The value to write to the utf.
@return The printer. */
SDK ::_::UTF2& operator<<(::_::UTF2& printer, UI1 value);

/* Writes the given value to the utf.
@param  printer The printer.
@param  value The value to write to the utf.
@return The printer. */
SDK ::_::UTF2& operator<<(::_::UTF2& printer, SI2 value);

/* Writes the given value to the utf.
@param  printer The printer.
@param  value The value to write to the utf.
@return The printer. */
SDK ::_::UTF2& operator<<(::_::UTF2& printer, UI2 value);

/* Writes the given value to the utf.
@return The printer.
@param  printer The printer.
@param  value The value to write to the utf. */
SDK ::_::UTF2& operator<<(::_::UTF2& printer, SI4 value);

/* Writes the given value to the utf.
@return The printer.
@param  printer The printer.
@param  value The value to write to the utf. */
SDK ::_::UTF2& operator<<(::_::UTF2& printer, UI4 value);

/* Writes the given value to the utf.
@return The printer.
@param  printer The printer.
@param  value The value to write to the utf. */
SDK ::_::UTF2& operator<<(::_::UTF2& printer, SI8 value);
...
@param  printer The printer.
@param  value The value to write to the utf. */
SDK ::_::UTF2& operator<<(::_::UTF2& printer, UI8 value);
...
@param  printer The printer.
@param  value The value to write to the utf. */
SDK ::_::UTF2& operator<<(::_::UTF2& printer, FLT value);

/* Writes the given value to the utf.
@return The printer.
@param  printer The printer.
@param  value The value to write to the utf. */
SDK ::_::UTF2& operator<<(::_::UTF2& printer, DBL value);
#endif
...
SDK ::_::UTF2& operator<<(::_::UTF2& printer, ::_::Utf16Center item);

/* Writes the given value to the utf justified right.
@return The printer.
@param  printer The printer.
@param  value The value to write to the utf. */
SDK ::_::UTF2& operator<<(::_::UTF2& printer, ::_::Utf16Right item);
