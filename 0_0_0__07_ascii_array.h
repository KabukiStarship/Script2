/* Script @version 0.x
@file    /kabuki/0/01_test_f2/00/00/seam.h
...
#if SEAM == _0_0_0__07
#include "0_0_0_debug.inl"
#else
#include "0_0_0_release.inl"
#endif

namespace _ {

static const char* _0_0_0__06_ASCII_Loom(char* seam_log, char* seam_end,
                                         const char* args) {
#if SEAM >= _0_0_0__07
  TEST_BEGIN;
  ...
  Compare(0, index) index = Loom2Find(multimap, "D");
  Compare(0, index) PAUSE("\n");
  index = Multimap2Add<uint8_t, UI1>(multimap, "C", (byte)0xFF);
  Compare(1, index) index = Loom2Find(multimap, "D");
  Compare(0, index) index = Loom2Find(multimap, "C");
  Compare(1, index);

  index = Multimap2Add<uint8_t, UI1>(multimap, "BIn", (byte)0xFF);
  Compare(2, index) index = Loom2Find(multimap, "D");
  Compare(0, index) index = Loom2Find(multimap, "C");
  Compare(1, index) index = Loom2Find(multimap, "BIn");
  Compare(2, index);

  index = Multimap2Add<uint8_t, UI1>(multimap, "A", (byte)0xFF);
  Compare(3, index) index = Loom2Find(multimap, "D");
  Compare(0, index) index = Loom2Find(multimap, "C");
  Compare(1, index) index = Loom2Find(multimap, "BIn");
  Compare(2, index) index = Loom2Find(multimap, "A");
  Compare(3, index);

  index = Multimap2Add<uint8_t, UI1>(multimap, "abc", (byte)0xFF);
  Compare(4, index) index = Loom2Find(multimap, "abc");
  Compare(4, index);

  index = Multimap2Add<uint8_t, UI1>(multimap, "bac", (byte)0xFF);
  Compare(5, index) index = Loom2Find(multimap, "abc");
  Compare(4, index) index = Loom2Find(multimap, "bac");
  Compare(5, index);

  index = Multimap2Add<uint8_t, UI1>(multimap, "cba", (byte)0xFF);
  Compare(6, index) index = Loom2Find(multimap, "abc");
  Compare(4, index) index = Loom2Find(multimap, "bac");
  Compare(5, index) index = Loom2Find(multimap, "cba");
  Compare(6, index);

  index = Multimap2Add<uint8_t, UI1>(multimap, "cab", (byte)0xFF);
  Compare(7, index) index = Loom2Find(multimap, "abc");
  Compare(4, index) index = Loom2Find(multimap, "bac");
  Compare(5, index) index = Loom2Find(multimap, "cba");
  Compare(6, index) index = Loom2Find(multimap, "cab");
  Compare(7, index);
