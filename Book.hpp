...
template<BOK_A>
CHA* TBookCopy(TBook<BOK_P>* origin, TBook<BOK_P>* destination) {
...
template<BOK_A>
inline ISA* TBookGetPtr(TBook<BOK_P>* book, ISY index) {
  return TListGetPtr<ISZ, T>(TBookKeys<BOK_P>(book), index);
}
