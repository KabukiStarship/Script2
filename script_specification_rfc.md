...
3. [SCRIPT Protocol Specification](#3-script-protocol-specification)
    1.  [Chinese Room Abstract Stack Machine (Crabs) Overview](#31-chinese-room-abstract-stack-machine-crabs-overview)
    2.  [Group Automata Theorem](#332-group-automata-theorem)
    3.  [Time](#33-time)
    4.  [Slots](#34-slots)
    5.  [Expressions](#35-expressions)
    6.  [Operations](#36-operations)
    7.  [Generic Handshake](#37-generic-handshake)
    8.  [Authentication](#38-authentication)
    9.  [Chinese Room Objects](#39-chinese-room-objects)
    10. [Quality of Service](#310-quality-of-service)
    11. [Profiles](#311-profiles)
    12. [Encryption](#312-encryption)
    13. [Terminals](#313-terminals)
    14. [Quality of Service](#314-quality-of-service)
    15. [Congestion Control](#315-congestion-control)
    16. [Abnormal Behavior](#316-abnormal-behavior)
    17. [Crabs Interpreters and Compilers](#317-crabs-interpreters-and-compilers)
    18. [Conformance Targets](#318-conformance-targets)
### 1.2. Author
