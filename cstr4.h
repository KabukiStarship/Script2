...
SDK const CH4* TStringDecimalEnd(const CH4* begin);

/* Skips the leading zeros of a number_ if there are any. */
SDK const CH4* TStringSkipChar(const CH4* begin, CH4 skip_char);

/* Skips all the spaces at the begin of the CH4. */
SDK const CH4* StringSkipSpaces(const CH4* begin);
...
SDK const CH4* StringSkipSpaces(const CH4* begin, const CH4* text_end);

/* Compares the source and query CH4 as nil-terminated strings. */
SDK const CH4* StringEquals(const CH4* text_a, const CH4* text_b);

/* Compares the source and query CH4 as nil-terminated strings. */
SDK const CH4* StringEquals(const CH4* begin, const CH4* stop,
                            const CH4* query);
...
SDK const CH4* StringFind(const CH4* begin, const CH4* query);
...
SDK CH4* Print(CH4* start, CH4* stop, const CH4* string_);
...
SDK CH4* Print(CH4* start, CH4* stop, UI4 value);
...
@param stop The stop address of the socket.
@param value The value to utf. */
SDK CH4* Print(CH4* start, CH4* stop, SI4 value);
...
@param stop The stop address of the socket.
@param value The value to utf. */
SDK CH4* Print(CH4* start, CH4* stop, UI8 value);
...
@param stop The stop address of the socket.
@param value The value to utf. */
SDK CH4* Print(CH4* start, CH4* stop, SI8 value);
...
@param stop The stop address of the socket.
@param value The value to utf. */
SDK CH4* Print(CH4* start, CH4* stop, FLT value);
...
@param stop The stop address of the socket.
@param value The value to utf. */
SDK CH4* Print(CH4* start, CH4* stop, DBL value);
#endif
...
@param stop    The stop address of the socket.
@param string_ The potentially unsafe string_ to write. */
SDK CH4* PrintCenter(CH4* start, CH4* stop, const CH4* string_,
                     SI4 column_count);
...
SDK CH4* PrintCenter(CH4* start, CH4* stop, CH4 character, SI4 column_count);
...
@param stop The stop address of the socket.
@param value The value to utf. */
SDK CH4* PrintCenter(CH4* start, CH4* stop, UI4 valu, SI4 column_count);
...
@param stop The stop address of the socket.
@param value The value to utf. */
SDK CH4* PrintCenter(CH4* start, CH4* stop, SI4 value, SI4 column_count);
...
@param stop The stop address of the socket.
@param value The value to utf. */
SDK CH4* PrintCenter(CH4* start, CH4* stop, UI8 value, SI4 column_count);
...
@param stop The stop address of the socket.
@param value The value to utf. */
SDK CH4* PrintCenter(CH4* start, CH4* stop, SI8 value, SI4 column_count);
...
@param stop The stop address of the socket.
@param value The value to utf. */
SDK CH4* PrintCenter(CH4* start, CH4* stop, FLT value, SI4 column_count);
...
@param stop The stop address of the socket.
@param value The value to utf. */
SDK CH4* PrintCenter(CH4* start, CH4* stop, DBL value, SI4 column_count);
#endif
...
@param stop    The stop address of the socket.
@param string_ The potentially unsafe string_ to write. */
SDK CH4* PrintRight(CH4* start, CH4* stop, const CH4* string_,
                    SI4 column_count);
...
@param stop       The stop address of the socket.
@param character The value to write. */
SDK CH4* PrintRight(CH4* start, CH4* stop, CH4 character, SI4 column_count);
...
@param stop The stop address of the socket.
@param value The value to utf. */
SDK CH4* PrintRight(CH4* start, CH4* stop, UI4 value, SI4 column_count);
...
@param stop The stop address of the socket.
@param value The value to utf. */
SDK CH4* PrintRight(CH4* start, CH4* stop, SI4 value, SI4 column_count);
...
@param stop The stop address of the socket.
@param value The value to utf. */
SDK CH4* PrintRight(CH4* start, CH4* stop, UI8 value, SI4 column_count);
...
@param stop The stop address of the socket.
@param value The value to utf. */
SDK CH4* PrintRight(CH4* start, CH4* stop, SI8 value, SI4 column_count);
...
@param stop The stop address of the socket.
@param value The value to utf. */
SDK CH4* PrintRight(CH4* start, CH4* stop, FLT value, SI4 column_count);
...
@param stop The stop address of the socket.
@param value The value to utf. */
SDK CH4* PrintRight(CH4* start, CH4* stop, DBL value, SI4 column_count);
#endif
...
SDK CH4* PrintHex(CH4* start, CH4* stop, const void* pointer);
...
@param stop The stop address of the socket.
@param value The value to utf. */
SDK CH4* PrintHex(CH4* start, CH4* stop, UI1 value);
...
@param stop The stop address of the socket.
@param value The value to utf. */
SDK CH4* PrintHex(CH4* start, CH4* stop, SI1 value);
...
@param stop The stop address of the socket.
@param value The value to utf. */
SDK CH4* PrintHex(CH4* start, CH4* stop, UI2 value);
...
@param stop The stop address of the socket.
@param value The value to utf. */
SDK CH4* PrintHex(CH4* start, CH4* stop, SI2 value);
...
@param stop The stop address of the socket.
@param value The value to utf. */
SDK CH4* PrintHex(CH4* start, CH4* stop, UI4 value);
...
@param stop The stop address of the socket.
@param value The value to utf. */
SDK CH4* PrintHex(CH4* start, CH4* stop, SI4 value);
...
@param stop The stop address of the socket.
@param value The value to utf. */
SDK CH4* PrintHex(CH4* start, CH4* stop, UI8 value);
...
@param stop The stop address of the socket.
@param value The value to utf. */
SDK CH4* PrintHex(CH4* start, CH4* stop, SI8 value);
...
@param stop The stop address of the socket.
@param value The value to utf. */
SDK CH4* PrintHex(CH4* start, CH4* stop, FLT value);
...
@param stop The stop address of the socket.
@param value The value to utf. */
SDK CH4* PrintHex(CH4* start, CH4* stop, DBL value);
#endif
...
SDK CH4* TPrintBinary(CH4* start, CH4* stop, const void* pointer);
...
@param stop The stop address of the socket.
@param value The value to utf. */
SDK CH4* TPrintBinary(CH4* start, CH4* stop, UI1 value);
...
@param stop The stop address of the socket.
@param value The value to utf. */
SDK CH4* TPrintBinary(CH4* start, CH4* stop, SI1 value);
...
@param stop The stop address of the socket.
@param value The value to utf. */
SDK CH4* TPrintBinary(CH4* start, CH4* stop, UI2 value);
...
@param stop The stop address of the socket.
@param value The value to utf. */
SDK CH4* TPrintBinary(CH4* start, CH4* stop, SI2 value);
...
@param stop The stop address of the socket.
@param value The value to utf. */
SDK CH4* TPrintBinary(CH4* start, CH4* stop, UI4 value);
...
@param stop The stop address of the socket.
@param value The value to utf. */
SDK CH4* TPrintBinary(CH4* start, CH4* stop, SI4 value);
...
@param stop The stop address of the socket.
@param value The value to utf. */
SDK CH4* TPrintBinary(CH4* start, CH4* stop, UI8 value);
...
@param stop The stop address of the socket.
@param value The value to utf. */
SDK CH4* TPrintBinary(CH4* start, CH4* stop, SI8 value);
...
@param stop The stop address of the socket.
@param value The value to utf. */
SDK CH4* TPrintBinary(CH4* start, CH4* stop, FLT value);
...
@param stop The stop address of the socket.
@param value The value to utf. */
SDK CH4* TPrintBinary(CH4* start, CH4* stop, DBL value);
#endif
...
SDK CH4* PrintSocket(CH4* start, CH4* stop, const void* begin, size_t size);
...
SDK CH4* PrintSocket(CH4* start, CH4* stop, const void* begin, const void* end);
...
SDK CH4* Print(CH4* start, CH4* stop, SI4 type, const void* value);
...
SDK CH4* PrintLine(CH4* cursor, CH4* stop, CH4 token, SI4 column_count);
...
SDK CH4* TPrintLineString(CH4* cursor, CH4* stop, const CH4* string_,
                          SI4 column_count);
...
of the read number_ or nil upon failure. */
SDK const CH4* Scan(const CH4* begin, SI1& result);
...
@return Returns a pointer to the next CH4 after the stop
of the read number_ or nil upon failure. */
SDK const CH4* Scan(const CH4* begin, UI1& result);
...
@return Returns a pointer to the next CH4 after the stop
of the read number_ or nil upon failure. */
SDK const CH4* Scan(const CH4* begin, SI2& result);
...
@return Returns a pointer to the next CH4 after the stop
of the read number_ or nil upon failure. */
SDK const CH4* Scan(const CH4* begin, UI2& result);
...
@return Returns a pointer to the next CH4 after the stop
of the read number_ or nil upon failure. */
SDK const CH4* Scan(const CH4* begin, SI4& result);
...
@return Returns a pointer to the next CH4 after the stop
of the read number_ or nil upon failure. */
SDK const CH4* Scan(const CH4* begin, UI4& result);
...
@return Returns a pointer to the next CH4 after the stop
of the read number_ or nil upon failure. */
SDK const CH4* Scan(const CH4* begin, SI8& result);
...
@return Returns a pointer to the next CH4 after the stop
of the read number_ or nil upon failure. */
SDK const CH4* Scan(const CH4* begin, UI8& result);
...
@return Returns a pointer to the next CH4 after the stop
of the read number_ or nil upon failure. */
SDK const CH4* Scan(const CH4* begin, FLT& result);
...
@return Returns a pointer to the next CH4 after the stop
of the read number_ or nil upon failure. */
SDK const CH4* Scan(const CH4* begin, DBL& result);
#endif
...
class Utf32Center {
 public:
  /* Prints the value to the text socket. */
  Utf32Center(const CH4* string_, SI4 column_count);

  /* Prints the value to the text socket. */
  Utf32Center(SI4 value, SI4 column_count);

  /* Prints the value to the text socket. */
  Utf32Center(UI4 value, SI4 column_count);

  /* Prints the value to the text socket. */
  Utf32Center(SI8 value, SI4 column_count);

  /* Prints the value to the text socket. */
  Utf32Center(UI8 value, SI4 column_count);

#if SEAM >= SCRIPT2_4
  /* Prints the value to the text socket. */
  Utf32Center(FLT value, SI4 column_count);

  /* Prints the value to the text socket. */
  Utf32Center(DBL value, SI4 column_count);
#endif
...
class Utf32Right {
 public:
  /* Prints the value to the text socket. */
  Utf32Right(const CH4* string_, SI4 column_count);

  /* Prints the value to the text socket. */
  Utf32Right(SI4 value, SI4 column_count);

  /* Prints the value to the text socket. */
  Utf32Right(UI4 value, SI4 column_count);

  /* Prints the value to the text socket. */
  Utf32Right(SI8 value, SI4 column_count);

  /* Prints the value to the text socket. */
  Utf32Right(UI8 value, SI4 column_count);

#if SEAM >= SCRIPT2_4
  /* Prints the value to the text socket. */
  Utf32Right(FLT value, SI4 column_count);

  /* Prints the value to the text socket. */
  Utf32Right(DBL value, SI4 column_count);
#endif
...
@param  value   The value to utf.
@return The printer. */
SDK ::_::UTF4& operator<<(::_::UTF4& printer, const CH4* string_);

/* Writes the given value to the utf.
@param  printer The printer.
@param  value   The value to utf.
@return The printer. */
SDK ::_::UTF4& operator<<(::_::UTF4& printer, CH4 value);

/* Writes the given value to the utf.
@param  printer The printer.
@param  value The value to write to the utf.
@return The printer. */
SDK ::_::UTF4& operator<<(::_::UTF4& printer, UI1 value);

/* Writes the given value to the utf.
@param  printer The printer.
@param  value The value to write to the utf.
@return The printer. */
SDK ::_::UTF4& operator<<(::_::UTF4& printer, SI2 value);

/* Writes the given value to the utf.
@param  printer The printer.
@param  value The value to write to the utf.
@return The printer. */
SDK ::_::UTF4& operator<<(::_::UTF4& printer, UI2 value);

/* Writes the given value to the utf.
@return The printer.
@param  printer The printer.
@param  value The value to write to the utf. */
SDK ::_::UTF4& operator<<(::_::UTF4& printer, SI4 value);

/* Writes the given value to the utf.
@return The printer.
@param  printer The printer.
@param  value The value to write to the utf. */
SDK ::_::UTF4& operator<<(::_::UTF4& printer, UI4 value);

/* Writes the given value to the utf.
@return The printer.
@param  printer The printer.
@param  value The value to write to the utf. */
SDK ::_::UTF4& operator<<(::_::UTF4& printer, SI8 value);
...
@param  printer The printer.
@param  value The value to write to the utf. */
SDK ::_::UTF4& operator<<(::_::UTF4& printer, UI8 value);
...
@param  printer The printer.
@param  value The value to write to the utf. */
SDK ::_::UTF4& operator<<(::_::UTF4& printer, FLT value);

/* Writes the given value to the utf.
@return The printer.
@param  printer The printer.
@param  value The value to write to the utf. */
SDK ::_::UTF4& operator<<(::_::UTF4& printer, DBL value);
#endif
...
SDK ::_::UTF4& operator<<(::_::UTF4& printer, ::_::Utf32Center item);

/* Writes the given value to the utf justified right.
@return The printer.
@param  printer The printer.
@param  value The value to write to the utf. */
SDK ::_::UTF4& operator<<(::_::UTF4& printer, ::_::Utf32Right item);
