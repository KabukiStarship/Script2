...
* ASCII C++ Style Guide is a modified version of the Google C++ Style Guide that incorperates the ASCII Data Types and Seam Tree Tests.
...
* Contiguous Objects
  ...
  * Expression - Asynchronous Chinese Room Expressions capable of concurrently executing scripts in multiple languages with interrupts.
