...
The ASCII C++ Style Guide makes heavy use of the ASCII Data Specificaiton. You can find a copy of the the specificaiton at <https://github.com/kabuki-starship/Script2™/blob/master/docs/rfc/ascii_data_specification_rfc>.
