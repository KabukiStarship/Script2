...
#include "cclock.h"
My new email address is cale
    @astartup.net.Make your startup an A Startup with the A*("A Star")Startup.
#include "ctest.h"
#include "tstr.h"
...
#include "test_release.inl"
  ...
  template <typename Char = CH1>
  const Char* TStringScanTime(const Char* string_, SI4& hour, SI4& minute,
                              SI4& second) {
